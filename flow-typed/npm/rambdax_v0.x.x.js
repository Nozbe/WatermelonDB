...
declare module rambdax {
  ...
  declare type Partial = (<A, R>((...r: [A]) => R, args: [A]) => () => R) &
    ...
    (<A, B, C, D, R>((...r: [A, B, C, D]) => R, args: [A, B, C]) => D => R) &
    (<A, B, C, D, R>((...r: [A, B, C, D]) => R, args: [A, B, C, D]) => () => R) &
    (<A, B, C, D, E, R>((...r: [A, B, C, D, E]) => R, args: [A]) => (B, C, D, E) => R) &
    (<A, B, C, D, E, R>((...r: [A, B, C, D, E]) => R, args: [A, B]) => (C, D, E) => R) &
    (<A, B, C, D, E, R>((...r: [A, B, C, D, E]) => R, args: [A, B, C]) => (D, E) => R) &
    (<A, B, C, D, E, R>((...r: [A, B, C, D, E]) => R, args: [A, B, C, D]) => E => R) &
    (<A, B, C, D, E, R>((...r: [A, B, C, D, E]) => R, args: [A, B, C, D, E]) => () => R) &
    (<A, B, C, D, E, F, R>((...r: [A, B, C, D, E, F]) => R, args: [A]) => (B, C, D, E, F) => R) &
    (<A, B, C, D, E, F, R>((...r: [A, B, C, D, E, F]) => R, args: [A, B]) => (C, D, E, F) => R) &
    (<A, B, C, D, E, F, R>((...r: [A, B, C, D, E, F]) => R, args: [A, B, C]) => (D, E, F) => R) &
    (<A, B, C, D, E, F, R>((...r: [A, B, C, D, E, F]) => R, args: [A, B, C, D]) => (E, F) => R) &
    (<A, B, C, D, E, F, R>((...r: [A, B, C, D, E, F]) => R, args: [A, B, C, D, E]) => F => R) &
  ...
  declare type PipeP = (<A, B, C, D, E, F, G>(
    ...
    (<A, B, C>(ab: UnaryPromiseFn<A, B>, bc: UnaryPromiseFn<B, C>) => UnaryPromiseFn<A, C>) &
  ...
  declare type RefineFilter = (<K, V, P: $Pred<1>, T: Array<V> | { [key: K]: V }>(
    fn: P,
    xs: T,
  ) => Array<$Refine<V, P, 1>>) &
  ...
  declare function pluck<V, K: string | number, T: Array<Array<V> | { [key: string]: V }>>(
    k: K,
    xs: T,
  ): Array<V>
  declare function pluck<V, K: string | number, T: Array<Array<V> | { [key: string]: V }>>(
  ...
  declare function remove<T>(
    from: number,
  ): ((to: number) => (src: Array<T>) => Array<T>) & ((to: number, src: Array<T>) => Array<T>)
  ...
  declare function update<T>(
    index: number,
  ): ((elem: T) => (src: Array<T>) => Array<T>) & ((elem: T, src: Array<T>) => Array<T>)
  ...
  declare function reduceRight<A, B>(fn: (elem: B, acc: A) => A, init: A): (xs: Array<B>) => A
  declare function reduceRight<A, B>(fn: (elem: B, acc: A) => A, init: A, xs: Array<B>): A
  ...
  declare function reduceWhile<A, B>(
    ...
    init: A,
  ) => (xs: Array<B>) => A & ((fn: (a: A, b: B) => A) => (init: A, xs: Array<B>) => A)) &
  ...
  declare function scan<A, B>(
    fn: (acc: A, elem: B) => A,
  ): ((init: A, xs: Array<B>) => Array<A>) & ((init: A) => (xs: Array<B>) => Array<A>)
  ...
  declare function zipWith<T, S, R>(
    fn: (a: T, b: S) => R,
  ): ((xs: Array<T>, ys: Array<S>) => Array<R>) & ((xs: Array<T>) => (ys: Array<S>) => Array<R>)
  ...
  declare type PropEq = (<T>(
    prop: $Keys<T>,
  ) => ((val: mixed) => (obj: T) => boolean) & ((val: mixed, obj: T) => boolean)) &
    (<T>(prop: $Keys<T>, val: mixed) => (obj: T) => boolean) &
    (<T>(prop: $Keys<T>, val: mixed, obj: T) => boolean) &
    // Array variants.
    (<T>(
      prop: number,
    ) => ((val: mixed) => (obj: Array<*>) => boolean) & ((val: mixed, obj: Array<*>) => boolean)) &
  ...
  declare function pathEq(
    path: Array<string>,
  ): ((val: any, o: Object) => boolean) & ((val: any) => (o: Object) => boolean)
  ...
  ): ((xs1: Array<T>) => (xs2: Array<T>) => Array<T>) & ((xs1: Array<T>, xs2: Array<T>) => Array<T>)
  declare function differenceWith<T>(
    fn: BinaryPredicateFn<T>,
    xs1: Array<T>,
  ): (xs2: Array<T>) => Array<T>
  ...
  ): (a: Array<A>) => (b: Array<B>) => Array<A> & ((a: Array<A>, b: Array<B>) => Array<A>)
  declare function innerJoin<A, B>(
    pred: (a: A, b: B) => boolean,
    a: Array<A>,
  ): (b: Array<B>) => Array<A>
  ...
  declare function intersectionWith<T>(
    fn: BinaryPredicateFn<T>,
  ): ((x: Array<T>, y: Array<T>) => Array<T>) & ((x: Array<T>) => (y: Array<T>) => Array<T>)
  declare function intersectionWith<T>(
    fn: BinaryPredicateFn<T>,
    x: Array<T>,
  ): (y: Array<T>) => Array<T>
  ...
  declare function maxBy<T, V>(fn: (x: T) => V): ((x: T, y: T) => T) & ((x: T) => (y: T) => T)
  ...
  declare function minBy<T, V>(fn: (x: T) => V): ((x: T, y: T) => T) & ((x: T) => (y: T) => T)
  ...
  declare function assoc<T, S>(
    key: string,
    ...args: Array<void>
  ): ((val: T) => (src: S) => { [k: string]: T }) & ((val: T, src: S) => { [k: string]: T } & S)
  declare function assoc<T, S>(
    key: string,
    val: T,
    ...args: Array<void>
  ): (src: S) => { [k: string]: T } & S
  declare function assoc<T, S>(key: string, val: T, src: S): { [k: string]: T } & S
  ...
  declare function assocPath<T, S>(key: Array<string>, val: T, src: S): { [k: string]: T } & S
  ...
  declare function eqProps(
    key: string,
    ...args: Array<void>
  ): ((o1: Object) => (o2: Object) => boolean) & ((o1: Object, o2: Object) => boolean)
  ...
  declare type Merge = (<A, B>(a: A, b: B) => A & B) & (<A, B>(a: A) => (b: B) => A & B)
  ...
  declare var mergeDeepRight: (<A, B>(a: A, b: B) => B & A) & (<A, B>(a: A) => (b: B) => B & A)
  ...
  declare type MergeWithKey = (<S: string, A: { [k: string]: mixed }, B: { [k: string]: mixed }, T>(
    fn: (s: S, a: T, b: T) => T,
    a: A,
    b: B,
  ) => A & B) &
  ...
  declare function pathOr<T, V, A: NestedObject<V>>(
    or: T,
  ): ((p: Array<string>) => (o: ?A) => V | T) & ((p: Array<string>, o: ?A) => V | T)
  ...
  declare function propOr<T, V, A: { [k: string]: V }>(or: T, p: string): (o: A) => V | T
  declare function propOr<T, V, A: { [k: string]: V }>(or: T, p: string, o: A): V | T

  declare function keysIn(o: Object): Array<string>

  declare function props<T: string, O>(keys: Array<T>): (o: O) => Array<$ElementType<O, T>>
  declare function props<T: string, O>(keys: Array<T>, o: O): Array<$ElementType<O, T>>
  ...
  declare function where<O>(predObj: $ObjMap<O, MapUnaryPredicateFn>, o: O): boolean
  ...
  declare function applySpec<V, S, A: Array<V>, T: NestedObject<(...args: A) => S>>(
    spec: T,
  ...
  ): ((arg0: B, arg1: A) => (arg2: C) => TResult) & ((arg0: B, arg1: A, arg2: C) => TResult)
  ...
  declare var o: (<A, B, C>(
    fn1: (b: B) => C,
    ...rest: void[]
  ) => ((fn2: (a: A) => B, ...rest: void[]) => (x: A) => C) & ((fn2: (a: A) => B, x: A) => C)) &
    (<A, B, C>(fn1: (b: B) => C, fn2: (a: A) => B, ...rest: void[]) => (x: A) => C) &
  ...
  declare function tryCatch<A, B, E>(
    tryer: (a: A) => B,
  ): ((catcher: (e: E, a: A) => B) => (a: A) => B) & ((catcher: (e: E, a: A) => B, a: A) => B)
  ...
  declare var pathSatisfies: CurriedFunction3<UnaryPredicateFn<any>, string[], Object, boolean>
  ...
  declare function unless<T, V, S>(pred: UnaryPredicateFn<T>, fn: (x: S) => V): (x: T | S) => V | T

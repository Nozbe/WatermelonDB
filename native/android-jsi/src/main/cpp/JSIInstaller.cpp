...
extern "C" JNIEXPORT void JNICALL Java_com_nozbe_watermelondb_jsi_JSIInstaller_provideJson(JNIEnv *env, jobject thiz, jstring json) {
    watermelondb::platform::provideJson(json);
}

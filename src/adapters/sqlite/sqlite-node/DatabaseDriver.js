...
class DatabaseDriver {
  ...
  query(table: string, query: string, args: any[]): any[] {
    return this._query(table, query, false, args)
  }

  cachedQuery(table: string, query: string, args: any[]): any[] {
    return this._query(table, query, true, args)
  }

  _query(table: string, query: string, willCache: boolean, args: any[]): any[] {
